...
- **YAML スキーマの単一の真実**は `domains/presentation/README.md`（[ADR-0013](./0013-deprecate-presentation-adopt-claude-design.md) により当領域は削除済み）。planner と renderer はこれを契約として参照していた。
